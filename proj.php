...
<body>
    ...
    <ul data-slides>
        ...
        while ($livros = mysqli_fetch_assoc($mostrarDestaques)):
            if ($contadorDestaques % 2 == 0): // Alteração aqui para exibir um livro por vez
        ?>
            <li id="livroDestaque" data-active>
                <div class="rating">
                ...
                <h2><?=$livros['nome'];?></h2>
                <p id="categoria">Categorias: <a href=""> categoria </a></p>
    ...
    <div class="botoes">
        <button id="botaoE" data-carousel-button="prev"><img src="botaoE.png"></button>
        <button id="botaoD" data-carousel-button="next"><img src="botaoD.png"></button>
    </div> 
</div>
